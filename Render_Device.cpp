...
namespace OVR { namespace Render {
	...
	void Model::AddBox(Color c, Vector3f origin, Vector3f size, Quatf rotation) {
		Vector3f s = size * .5f;
		Vector3f o = origin;
		std::vector<Vector3f> vecsOToPs;
		vecsOToPs.push_back(Vector3f(-s.x, s.y, -s.z));
		vecsOToPs.push_back(Vector3f(s.x, s.y, -s.z));
		vecsOToPs.push_back(Vector3f(-s.x, -s.y, -s.z));
		vecsOToPs.push_back(Vector3f(s.x, -s.y, -s.z));
		vecsOToPs.push_back(Vector3f(-s.x, s.y, s.z));
		...
		for (unsigned int i = 0; i < vecsOToPs.size(); i++) {
			vs.push_back(rotation.Rotate(vecsOToPs.at(i)) + o);
		}
		...
		AddVertex(vs[5].x, vs[5].y, vs[5].z, c, 1, 0, 0, 0, 1);
		AddVertex(vs[4].x, vs[4].y, vs[4].z, c, 0, 0, 0, 0, 1);
		AddVertex(vs[6].x, vs[6].y, vs[6].z, c, 0, 1, 0, 0, 1);
		AddVertex(vs[7].x, vs[7].y, vs[7].z, c, 1, 1, 0, 0, 1);
		AddTriangle(6 + i, 5 + i, 4 + i);
		AddTriangle(4 + i, 7 + i, 6 + i);

		AddVertex(vs[0].x, vs[0].y, vs[0].z, c, 1, 0, -1, 0, 0);
		AddVertex(vs[4].x, vs[4].y, vs[4].z, c, 1, 1, -1, 0, 0);
		AddVertex(vs[6].x, vs[6].y, vs[6].z, c, 0, 1, -1, 0, 0);
		AddVertex(vs[2].x, vs[2].y, vs[2].z, c, 0, 0, -1, 0, 0);
		AddTriangle(10 + i, 11 + i, 8 + i);
		AddTriangle(8 + i, 9 + i, 10 + i);

		AddVertex(vs[1].x, vs[1].y, vs[1].z, c, 1, 1, 1, 0, 0);
		AddVertex(vs[3].x, vs[3].y, vs[3].z, c, 0, 1, 1, 0, 0);
		AddVertex(vs[7].x, vs[7].y, vs[7].z, c, 0, 0, 1, 0, 0);
		AddVertex(vs[5].x, vs[5].y, vs[5].z, c, 1, 0, 1, 0, 0);
		AddTriangle(14 + i, 15 + i, 12 + i);
		AddTriangle(12 + i, 13 + i, 14 + i);

		AddVertex(vs[6].x, vs[6].y, vs[6].z, c, 0, 0, 0, -1, 0);
		AddVertex(vs[7].x, vs[7].y, vs[7].z, c, 1, 0, 0, -1, 0);
		AddVertex(vs[3].x, vs[3].y, vs[3].z, c, 1, 1, 0, -1, 0);
		AddVertex(vs[2].x, vs[2].y, vs[2].z, c, 0, 1, 0, -1, 0);
		AddTriangle(18 + i, 19 + i, 16 + i);
		AddTriangle(16 + i, 17 + i, 18 + i);

		AddVertex(vs[0].x, vs[0].y, vs[0].z, c, 0, 0, 0, 1, 0);
		AddVertex(vs[1].x, vs[1].y, vs[1].z, c, 1, 0, 0, 1, 0);
		AddVertex(vs[5].x, vs[5].y, vs[5].z, c, 1, 1, 0, 1, 0);
		AddVertex(vs[4].x, vs[4].y, vs[4].z, c, 0, 1, 0, 1, 0);
